        ...
        try:
            ...
            if data.get('rt_cd') == '0':  # 성공
                ...
                return {
                    ...
                    'previous_close': float(output.get('bfdy_clpr', 0)) if output.get('bfdy_clpr') else None,  # 전일종가
                    'current_price': float(output.get('thdt_clpr', 0)) if output.get('thdt_clpr') else None,   # 당일종가 (현재가 대신)
                }
